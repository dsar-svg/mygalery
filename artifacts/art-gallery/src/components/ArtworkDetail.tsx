        ...
        >
          <div className="space-y-8">
            <div className="flex items-center gap-4">
               ...
               <p className="text-[10px] font-black uppercase tracking-[0.4em] opacity-60">Pieza de Exhibición:</p>
            </div>
